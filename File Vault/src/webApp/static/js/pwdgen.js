...
function close_gen(pwd_new_input){
	var pwd_input = document.getElementById(pwd_new_input);
	var gen_pwd_input = document.getElementById("result");

	if(gen_pwd_input.innerText != "CLICK GENERATE"){
		pwd_input.value = gen_pwd_input.innerText;
		...
		gen_pwd_input.style.color = "#e45757";
	}
}